  ...
  return (
    ...
    <div className="bg-white max-w-3xl relative min-h-screen flex flex-col justify-center">
      ...
      <div className="px-8">
        ...
        <p className="mt-4 mb-8 font-medium text-xl">{t.NOTFOUND.TEXT}</p>
        <Link href="/" className="border-4 border-black px-4 py-2 font-semibold duration-200 hover:bg-black hover:text-white">
          {t.NOTFOUND.RETURN}
        </Link>
      </div>
    </div>
